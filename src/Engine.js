...
function init(elem, parentObject){
    ...
    switch(elem.type){
        ...
        case "AccordionPanel":
            ...
            elem.object = new asdf_AccordionPanel(elem.id, parentObject, elem.position_x, elem.position_y, elem.background_color, elem.position_type, elem.start_page,elem.extra_css, elem.collapse, elem.spacing_between_elements, pages,  elem.initial_show, elem.layer_level );
            registerActions(elem);           
		break;
        case "Image":
...
function getActionHandler(actionElement){
    ...
    if(actionElement.name == "toggle_visibility")
        return ActionHandlerToggle;
